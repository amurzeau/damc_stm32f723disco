/**
  ******************************************************************************
  * @file    stm32n6570_discovery_usbpd_pwr.c
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup STM32N6570_DK_USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
uint8_t ADC_Configured = USBPD_FALSE;

/**
  * @}
  */

/** @addtogroup STM32N6570_DK_USBPD_PWR_Exported_Functions
  * @{
  */
...
/** @addtogroup STM32N6570_DK_USBPD_PWR_Private_Functions
  * @{
  */
